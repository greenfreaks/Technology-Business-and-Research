...
;(function ($, anim) {
  ...
  var Collapsible = function (_Component) {
    ...
    function Collapsible(el, options) {
       ...
       * @prop {Function} onStart - Callback function called before collapsible is opened
       * @prop {Function} onEnd - Callback function called after collapsible is opened
        ...
        if ($collapsibleLi.length) {
          ...
          anim({
            ...
            complete: function (anim) {
              ...
              // onEnd callback
              if (typeof _this5.options.onEnd === 'function') {
                _this5.options.onEnd.call(_this5, $collapsibleLi[0]);
              }
            }
          });
        }
      ...
      value: function open(index) {
        ...
        if ($collapsibleLi.length && !$collapsibleLi[0].classList.contains('active')) {
          ...
          if (typeof this.options.onStart === 'function') {
            this.options.onStart.call(this, $collapsibleLi[0]);
          }
...
;(function ($, anim) {
  ...
  var Dropdown = function (_Component2) {
    ...
    function Dropdown(el, options) {
       ...
       * @prop {Function} onStart - Function called when dropdown starts opening
       * @prop {Function} onEnd - Function called when dropdown finishes opening
    ...
    _createClass(Dropdown, [{
      ...
      value: function _animateIn() {
        ...
        anim({
          ...
          complete: function (anim) {
            ...
            // onEnd callback
            if (typeof _this10.options.onEnd === 'function') {
              var elem = anim.animatables[0].target;
              _this10.options.onEnd.call(elem, _this10.el);
            }
          }
        });
      }
      ...
      value: function open() {
        ...
        // onStart callback
        if (typeof this.options.onStart === 'function') {
          this.options.onStart.call(this, this.el);
        }
...
;(function ($, anim) {
  ...
  var Modal = function (_Component3) {
    ...
    function Modal(el, options) {
       ...
       * @prop {Function} onStart - Callback function called before modal is opened
       * @prop {Function} onEnd - Callback function called after modal is opened
    ...
    _createClass(Modal, [{
      ...
      value: function _animateIn() {
        ...
        var enterAnimOptions = {
          ...
          duration: this.options.inDuration,
          easing: 'easeOutCubic',
          // Handle modal onEnd callback
          complete: function () {
            if (typeof _this13.options.onEnd === 'function') {
              _this13.options.onEnd.call(_this13, _this13.el, _this13._openingTrigger);
            }
          }
        };
      ...
      value: function open($trigger) {
        ...
        // onStart callback
        if (typeof this.options.onStart === 'function') {
          this.options.onStart.call(this, this.el, this._openingTrigger);
        }
...
;(function ($, anim) {
  ...
  var Materialbox = function (_Component4) {
    ...
    function Materialbox(el, options) {
       ...
       * @prop {Function} onStart - Callback function called before materialbox is opened
       * @prop {Function} onEnd - Callback function called after materialbox is opened
      ...
      value: function _animateImageIn() {
        ...
        var animOptions = {
          ...
          complete: function () {
            ...
            // onEnd callback
            if (typeof _this16.options.onEnd === 'function') {
              _this16.options.onEnd.call(_this16, _this16.el);
            }
          }
        };
...
;(function ($, anim) {
  ...
  var Sidenav = function (_Component8) {
    ...
    function Sidenav(el, options) {
       ...
       * @prop {Number} [inDuration=250] - Length in ms of enter transition
       * @prop {Number} [outDuration=200] - Length in ms of exit transition
       * @prop {Function} onStart - Function called when sidenav starts entering
       * @prop {Function} onEnd - Function called when sidenav finishes entering
    ...
    _createClass(Sidenav, [{
      ...
      value: function _animateSidenavIn() {
        ...
        anim({
          ...
          complete: function () {
            // Run onEnd callback
            if (typeof _this31.options.onEnd === 'function') {
              _this31.options.onEnd.call(_this31, _this31.el);
            }
          }
        });
      }
  ...
  var Datepicker = function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function open() {
        ...
        this.isOpen = true;
        if (typeof this.options.on === 'function') {
...
;(function ($) {
  ...
  var TapTarget = function (_Component19) {
    ...
    function TapTarget(el, options) {
       ...
       * @prop {Function} on - Callback function called when feature discovery is opened
    ...
    _createClass(TapTarget, [{
      ...
      value: function open() {
        ...
        // on callback
        if (typeof this.options.on === 'function') {
          this.options.on.call(this, this.$origin[0]);
        }
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onEnd = function (el) {
