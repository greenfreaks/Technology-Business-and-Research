...
<div class="section">
    <div class="container cta-bg white-text center">
        <div class="row">
            <div class="col s12">
                <h4>TB&amp;R Ofrece diversos servicios para ayudarte a preparar tu participación en el Programa EFIDT 2019 </h4>
            </div>
        </div>
        <div class="row">
            <div class="col l4 s12">
                <a href="http://www.techbusiness.com.mx/modulos/catalogo/talleres/calendario.html" class="waves-effect waves-light btn cta"><i class="material-icons right">settings</i>Talleres</a>
                <p class="blanco-transparente black-text">Aprende todo lo que hay que saber del EFIDT 2019 en uno de nuestros talleres, revisa nuestro calendario para ver todas nuestras fechas y sedes.</p>
            </div>
            <div class="col l4 s12">
                <a href="http://www.techbusiness.com.mx/modulos/catalogo/servicios/asesoria_EFIDT.html" class="waves-effect waves-light btn cta"><i class="material-icons right">supervised_user_circle</i>Asesorias</a>
                <p class="blanco-transparente black-text">Ofrecemos el acompañamiento necesario para desarrollar el contenido técnico y financiero adecuado para optimizar la formulación y el crédito fiscal a obtener en el Programa.</p>
            </div>
            <div class="col l4 s12">
                <a href="http://www.techbusiness.com.mx/modulos/EFIDT2019/pre-evaluacion.html" class="waves-effect waves-light btn cta"><i class="material-icons right">assignment_turned_in</i>Evaluaciones</a>
                <p class="blanco-transparente black-text">Incremente la calidad de su propuesta y sus probabilidades de aprobación realizando una pre-evaluación de su proyecto para detectar y solventar áreas de mejora y puntos débiles.</p>
            </div>
        </div>
    </div>
</div>
